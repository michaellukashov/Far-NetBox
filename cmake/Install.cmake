...
# Create a custom target for .lng files to ensure they are copied when changed,
# not only when NetBox.dll is generated
file(GLOB LNG_FILES "${CMAKE_SOURCE_DIR}/src/NetBox/*.lng")
if(LNG_FILES)
add_custom_target(copy_lng_files ALL COMMENT "")
foreach(LNG_FILE ${LNG_FILES})
  get_filename_component(LNG_NAME ${LNG_FILE} NAME)
  add_custom_command(TARGET copy_lng_files POST_BUILD VERBATIM
    COMMAND
      ${CMAKE_COMMAND} --quiet
      "-DFILE_NAME=${LNG_NAME}"
      "-DFULL_FILE_NAME=${LNG_FILE}"
      "-DNETBOX_PLUGIN_DIR=${NETBOX_PLUGIN_DIR}"
      -P "${CMAKE_SOURCE_DIR}/cmake/copy_file.cmake"
    COMMENT "Copying ${LNG_NAME} to plugin directory"
  )
endforeach()
endif()
endfunction()
