...
private:
  ...
  void SetHostName(AnsiString value);
  void SetPortNumber(int value);
  void SetUserName(AnsiString value);
  void SetPassword(AnsiString value);
  ...
  void SetGSSAPIServerRealm(AnsiString value);
  ...
  void SetPublicKeyFile(AnsiString value);

  void SetProtocolStr(AnsiString value);
  AnsiString GetProtocolStr() const;
  bool GetCanLogin();
  ...
  AnsiString GetSessionName();
  AnsiString GetDefaultSessionName();
  AnsiString GetSessionUrl();
  void SetProtocol(TProtocol value);
  void SetFSProtocol(TFSProtocol value);
  AnsiString GetFSProtocolStr();
  void SetLocalDirectory(AnsiString value);
  void SetRemoteDirectory(AnsiString value);
  ...
  void SetReturnVar(AnsiString value);
  void SetScp1Compatibility(bool value);
  void SetShell(AnsiString value);
  void SetSftpServer(AnsiString value);
  void SetTimeout(int value);
  void SetUnsetNationalVars(bool value);
  void SetIgnoreLsWarnings(bool value);
  void SetTcpNoDelay(bool value);
  AnsiString GetSshProtStr();
  bool GetUsesSsh();
  void SetCipherList(AnsiString value);
  AnsiString GetCipherList() const;
  void SetKexList(AnsiString value);
  AnsiString GetKexList() const;
  void SetProxyMethod(TProxyMethod value);
  void SetProxyHost(AnsiString value);
  void SetProxyPort(int value);
  void SetProxyUsername(AnsiString value);
  void SetProxyPassword(AnsiString value);
  void SetProxyTelnetCommand(AnsiString value);
  void SetProxyLocalCommand(AnsiString value);
  void SetProxyDNS(TAutoSwitch value);
  void SetProxyLocalhost(bool value);
  AnsiString GetProxyPassword() const;
  void SetFtpProxyLogonType(int value);
  void SetBug(TSshBug Bug, TAutoSwitch value);
  TAutoSwitch GetBug(TSshBug Bug) const;
  AnsiString GetSessionKey();
  void SetCustomParam1(AnsiString value);
  void SetCustomParam2(AnsiString value);
  ...
  AnsiString GetStorageKey();
  AnsiString GetInternalStorageKey();
  void SetDSTMode(TDSTMode value);
  void SetDeleteToRecycleBin(bool value);
  void SetOverwrittenToRecycleBin(bool value);
  void SetRecycleBinPath(AnsiString value);
  void SetPostLoginCommands(AnsiString value);
  void SetAddressFamily(TAddressFamily value);
  void SetRekeyData(AnsiString value);
  void SetRekeyTime(unsigned int value);
  void SetColor(int value);
  void SetTunnel(bool value);
  void SetTunnelHostName(AnsiString value);
  void SetTunnelPortNumber(int value);
  void SetTunnelUserName(AnsiString value);
  void SetTunnelPassword(AnsiString value);
  AnsiString GetTunnelPassword();
  void SetTunnelPublicKeyFile(AnsiString value);
  void SetTunnelPortFwd(AnsiString value);
  ...
  void SetFtpAccount(AnsiString value);
  ...
  void SetHostKey(AnsiString value);
  TDateTime GetTimeoutDT();
  void SavePasswords(THierarchicalStorage * Storage, bool PuttyExport);
  AnsiString GetLocalName();
  void Modify();
  AnsiString GetSource();
  static AnsiString EncryptPassword(const AnsiString & Password, AnsiString Key);
  static AnsiString DecryptPassword(const AnsiString & Password, AnsiString Key);
  static AnsiString StronglyRecryptPassword(const AnsiString & Password, AnsiString Key);

  __property AnsiString InternalStorageKey = { read = GetInternalStorageKey };

public:
  TSessionData(AnsiString aName);
  void Default();
  void NonPersistant();
  ...
  bool ParseUrl(AnsiString Url, TOptions * Options,
  ...
  static void ValidatePath(const AnsiString Path);
  static void ValidateName(const AnsiString Name);
...
public:
  ...
  void Load(AnsiString aKey, bool UseDefaults);
  void Load();
  ...
  TSessionData * NewSession(AnsiString SessionName, TSessionData * Session);
  TSessionData * ParseUrl(AnsiString Url, TOptions * Options, bool & DefaultsOnly,
  ...
  static void ImportHostKeys(const AnsiString TargetKey,
