...
public:
	...
	inline void Enter()	{ EnterCriticalSection(&_SyncObj); }

	//Release the critical section
	inline void Leave()	{ LeaveCriticalSection(&_SyncObj); }
...
{
public:
	CLock(CCriticalSection& syncObj) : _SyncObj(syncObj)	{ _SyncObj.Enter(); }
	~CLock()												{ _SyncObj.Leave(); }
private:
