...
public:
	 ...
	 */
	inline int GetTop() const		{ return _UseFrame ? 2 : 0; }

	/**
	 * Get left dialog coordinate
	 * \return left dialog coordinate
	 */
	inline int GetLeft() const		{ return _UseFrame ? 5 : 0; }

	/**
	 * Get dialogs width
	 * \return width
	 */
	inline int GetWidth() const		{ return _Width - (_UseFrame ? 6 : 0); }

	/**
	 * Get dialogs height
	 * \return height
	 */
	inline int GetHeight() const	{ return _Height - (_UseFrame ? 2 : 0); }
