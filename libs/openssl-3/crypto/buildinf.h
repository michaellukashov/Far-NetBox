...
#define DATE "built on: Thu Jan  4 03:53:03 2024 UTC"
#endif
...
static const char compiler_flags[] = {
    ...
    '"','_','A','R','M','_','W','I','N','A','P','I','_','P','A','R',
    'T','I','T','I','O','N','_','D','E','S','K','T','O','P','_','S',
    'D','K','_','A','V','A','I','L','A','B','L','E','"',' ','-','D',
    '"','O','P','E','N','S','S','L','_','S','Y','S','_','W','I','N',
    '_','C','O','R','E','"',' ','-','D','"','N','D','E','B','U','G',
    '"','\0'
};
#else
#if defined(_WIN64) || defined(OPENSSL_SYS_WIN64)
