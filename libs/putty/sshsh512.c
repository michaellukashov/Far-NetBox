...
static void SHA512_Core_Init(putty_SHA512_State* s)
{
...
static void SHA384_Core_Init(putty_SHA512_State* s)
{
  static const uint64 iv[] =
  {
...
static void SHA512_Block(putty_SHA512_State* s, uint64* block)
{
  uint64 w[80];
...
void putty_SHA512_Init(putty_SHA512_State* s)
{
  int i;
  SHA512_Core_Init(s);
  s->blkused = 0;
...
void putty_SHA384_Init(putty_SHA512_State* s)
{
  int i;
  SHA384_Core_Init(s);
  s->blkused = 0;
...
void putty_SHA512_Bytes(putty_SHA512_State* s, const void* p, int len)
{
...
{
  const putty_SHA512_State* old = (const putty_SHA512_State*)vold;
  putty_SHA512_State* s;
...
int main(void)
{
  ...
  for (i = 0; i < sizeof(tests) / sizeof(*tests); i++)
  {
    ...
    {
      putty_SHA512_Simple(tests[i].teststring,
