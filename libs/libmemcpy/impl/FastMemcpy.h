...
#if defined(_MSC_VER)
typedef __declspec(align(1)) uint16_t uint16_unaligned_t;
typedef __declspec(align(1)) uint32_t uint32_unaligned_t;
typedef __declspec(align(1)) uint64_t uint64_unaligned_t;
typedef __declspec(align(1)) size_t size_unaligned_t;
#else
...
typedef __attribute__((__aligned__(1))) size_t size_unaligned_t;
#endif
//---------------------------------------------------------------------
