...
/* ========================================================================= */
int ZEXPORT deflateSetDictionary(z_stream *strm, const uint8_t *dictionary, uint32_t dictLength)
{
    deflate_state *s;
    uint32_t str, n;
    int wrap;
...
/* ========================================================================= */
int ZEXPORT deflateGetDictionary(z_stream *strm, uint8_t *dictionary, uint32_t *dictLength)
{
    deflate_state *s;
    uint32_t len;
