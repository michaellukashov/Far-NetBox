...
- [x] **TASK-4: Update SetDirectoryEx to populate FarPanelDirectory::Param**
...
- [ ] **TASK-9: Write unit tests for session history utilities**
  ...
  - **Note:** No existing test infrastructure in the project (no tests/ directory, no test framework). Unit tests deferred pending test framework setup.
