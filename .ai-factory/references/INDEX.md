...
| [winscp-source-architecture](winscp-source-architecture.md) | WinSCP source code architecture and integration guide | D:\Projects\WinSCP-work\winscp-master\source | 2026-04-22 |
  | [fix-issue-389-pureftpd-tls-explicit](fix-issue-389-pureftpd-tls-explicit.md) | **FIXED** — Full investigation: AUTH TLS→SSL fallback, OpenSSL bn_div_words crash, session log debugging, state machine traces | FtpControlSocket.cpp, AsyncSslSocketLayer.cpp, Cryptography.cpp, FtpFileSystem.cpp | 2026-05-02 |
...
| [fix-issue-389-pureftpd-tls-explicit](fix-issue-389-pureftpd-tls-explicit.md) | **BUG FOUND** — OpenSSL 3 bn_div_words division-by-zero in NASM assembly affecting RSA/EC operations; workaround via SSL_set_max_proto_version(TLS1_2) + SSL_VERIFY_NONE | bn_asm.c, bn_div.c, ecp_mont.c, rsa_sig.c, statem_clnt.c | 2026-05-02 |