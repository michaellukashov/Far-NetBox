...
| [fix-issue-389-tlscertificatefile-dialog-control](../plans/fix-issue-389-tlscertificatefile-dialog-control.md) | Add `TlsCertificateFile` UI control (label + edit + browse button) to session dialog FTP tab. Allows viewing/clearing stale certificate paths from WinSCP imports that caused OpenSSL init failures. | WinSCPDialogs.cpp, MsgIDs.h, NetBox*.lng | 2026-05-02 |