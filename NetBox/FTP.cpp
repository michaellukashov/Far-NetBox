...
// 	t (sticky bit)
	...
	if (perm[0] == 'r' || perm[0] == 'R') ret |= (1 << 10);
	if (perm[1] == 'w' || perm[1] == 'W') ret |= (1 << 9);
	if (perm[2] == 'x' || perm[2] == 'X') ret |= (1 << 8);
	if (perm[3] == 'r' || perm[3] == 'R') ret |= (1 << 6);
	if (perm[4] == 'w' || perm[4] == 'W') ret |= (1 << 5);
	if (perm[5] == 'x' || perm[5] == 'X') ret |= (1 << 4);
	if (perm[6] == 'r' || perm[6] == 'R') ret |= (1 << 2);
	if (perm[7] == 'w' || perm[7] == 'W') ret |= (1 << 1);
	if (perm[8] == 'x' || perm[8] == 'X') ret |= (1 << 0);
	return ret;
}
