...
enum MsgIDs {
    ...
    NB_S3_MIN_TLS_VERSION,
    NB_S3_MAX_TLS_VERSION,
    NB_S3_LOAD_CA_CERT,
    NB_S3_SAVE_CA_CERT,
    NB_S3_INVALID_PEM,
    NB_S3_LOAD_ERROR,
    NB_S3_SAVE_ERROR,
    NB_LOGIN_AUTH_OPENSSH_CERT_GROUP,
    NB_LOGIN_AUTH_USE_OPENSSH_CERT,
    NB_LOGIN_AUTH_OPENSSH_CERT_FILE,
    NB_LOGIN_AUTH_OPENSSH_KEY_FILE,
};
