...
//  friend inline bool operator==(const UnicodeString &Str1, const RawByteString &Str2);
//  friend inline bool operator!=(const UnicodeString &Str1, const RawByteString &Str2);
...
public:
  ...
  { return lhs.Data == UnicodeString(rhs.Data); }
  inline friend bool operator!=(const UnicodeString &lhs, const RawByteString &rhs)
  { return lhs.Data != UnicodeString(rhs.Data); }
...
//inline bool operator==(const UnicodeString &Str1, const RawByteString &Str2) { return Str1.Data == Str2.Data; }
//inline bool operator!=(const UnicodeString &Str1, const RawByteString &Str2) { return Str1.Data != Str2.Data; }
