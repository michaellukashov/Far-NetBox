...
//---------------------------------------------------------------------------
UnicodeString TSFTPFileSystem::FileUrl(const UnicodeString & AFileName) const
{
  return FTerminal->FileUrl(SftpProtocol, AFileName);
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void TSFTPFileSystem::SFTPConfirmOverwrite(UnicodeString & AFileName,
