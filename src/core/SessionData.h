...
public:
  ...
  void __fastcall SetPassphrase(UnicodeString AValue);
  ...
  UnicodeString __fastcall GetInfoTip() const;
  ...
  UnicodeString __fastcall GetSshProtStr() const;
  bool __fastcall GetUsesSsh() const;
