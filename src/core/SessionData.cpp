...
const wchar_t KexNames[KEX_COUNT][20] = {L"WARN", L"dh-group1-sha1", L"dh-group14-sha1", L"dh-gex-sha1", L"gss-group1-sha1", L"gss-group14-sha1", L"gss-gex-sha1", L"rsa",  L"ecdsa-sha2-nistp521" };
