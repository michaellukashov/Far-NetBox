...
{
public:
  virtual HRESULT STDMETHODCALLTYPE GetImageList(int32_t imageList, HIMAGELIST* pHImageList) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetImageList(int32_t imageList, HIMAGELIST hNewImageList, HIMAGELIST* pHOldImageList) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetItemCount(int32_t itemCount, DWORD flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetItem(LVITEMW* pItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetItem(LVITEMW* const pItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetItemState(int32_t itemIndex, int32_t subItemIndex, ULONG mask, ULONG* pState) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetItemState(int32_t itemIndex, int32_t subItemIndex, ULONG mask, ULONG state) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetItemText(int32_t itemIndex, int32_t subItemIndex, LPWSTR pBuffer, int32_t bufferSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetItemText(int32_t itemIndex, int32_t subItemIndex, LPCWSTR pText) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetSelectedColumn(int32_t columnIndex) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE DeleteItem(int32_t itemIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE DeleteAllItems(void) = 0;
  virtual HRESULT STDMETHODCALLTYPE UpdateItem(int32_t itemIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetItemRect(LVITEMINDEX itemIndex, int32_t rectangleType, LPRECT pRectangle) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSubItemRect(LVITEMINDEX itemIndex, int32_t subItemIndex, int32_t rectangleType, LPRECT pRectangle) = 0;
  virtual HRESULT STDMETHODCALLTYPE HitTestSubItem(LVHITTESTINFO* pHitTestData) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIncrSearchString(PWSTR pBuffer, int32_t bufferSize, PINT pCopiedChars) = 0;
  ...
  // parameters may be in wrong order
  virtual HRESULT STDMETHODCALLTYPE SetIconSpacing(int32_t horizontalSpacing, int32_t verticalSpacing, PINT pHorizontalSpacing, PINT pVerticalSpacing) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetItemPosition(int32_t itemIndex, POINT const* pPosition) = 0;
  // parameters may be in wrong order
  virtual HRESULT STDMETHODCALLTYPE ScrollView(int32_t horizontalScrollDistance, int32_t verticalScrollDistance) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnsureItemVisible(LVITEMINDEX itemIndex, BOOL partialOk) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnsureSubItemVisible(LVITEMINDEX itemIndex, int32_t subItemIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE EditSubItem(LVITEMINDEX itemIndex, int32_t subItemIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE RedrawItems(int32_t firstItemIndex, int32_t lastItemIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE ArrangeItems(int32_t mode) = 0;
  virtual HRESULT STDMETHODCALLTYPE RecomputeItems(int32_t unknown) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE EditGroupLabel(int32_t groupIndex) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetColumn(int32_t columnIndex, LVCOLUMNW* pColumn) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetColumn(int32_t columnIndex, LVCOLUMNW* const pColumn) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetColumnOrderArray(int32_t numberOfColumns, PINT pColumns) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetColumnOrderArray(int32_t numberOfColumns, int32_t const* pColumns) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetHeaderControl(HWND* pHWndHeader) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertColumn(int32_t insertAt, LVCOLUMNW* const pColumn, PINT pColumnIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE DeleteColumn(int32_t columnIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateDragImage(int32_t itemIndex, POINT const* pUpperLeft, HIMAGELIST* pHImageList) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetColumnWidth(int32_t columnIndex, PINT pWidth) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetColumnWidth(int32_t columnIndex, int32_t width) = 0;
  ...
  // parameters may be in wrong order
  virtual HRESULT STDMETHODCALLTYPE ApproximateViewRect(int32_t itemCount, PINT pWidth, PINT pHeight) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetRangeObject(int32_t unknown, LPVOID/*ILVRange**/ pObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetWorkAreas(int32_t numberOfWorkAreas, RECT* pWorkAreas) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetWorkAreas(int32_t numberOfWorkAreas, RECT const* pWorkAreas) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetGroupInfo(int32_t unknown1, int32_t unknown2, LVGROUP* pGroup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGroupInfo(int32_t unknown, int32_t groupID, LVGROUP* const pGroup) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGroupRect(BOOL unknown, int32_t groupID, int32_t rectangleType, RECT* pRectangle) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGroupState(int32_t groupID, ULONG mask, ULONG* pState) = 0;
  virtual HRESULT STDMETHODCALLTYPE HasGroup(int32_t groupID, BOOL* pHasGroup) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertGroup(int32_t insertAt, LVGROUP* const pGroup, PINT pGroupID) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveGroup(int32_t groupID) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetFrozenItem(int32_t unknown1, int32_t unknown2) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFrozenSlot(RECT* pUnknown) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFrozenSlot(int32_t unknown1, POINT const* pUnknown2) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE MapIndexToId(int32_t itemIndex, PINT pItemID) = 0;
  virtual HRESULT STDMETHODCALLTYPE MapIdToIndex(int32_t itemID, PINT pItemIndex) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetGroupSubsetCount(int32_t numberOfRowsToDisplay) = 0;
