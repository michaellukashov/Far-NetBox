...
private:
  ...
  std::string ToStdString(const UnicodeString & String) const { return std::string(Sysutils::W2MB(String.c_str()).c_str()); }
  UnicodeString ToUnicodeString(const char * String) const { return Sysutils::MB2W(String ? String : ""); }
