...
private:
  ...
  inline DWORD TerminalGetLocalFileAttributes(UnicodeString LocalFileName) const;
  inline BOOL TerminalSetLocalFileAttributes(UnicodeString LocalFileName, DWORD FileAttributes);
