...
enum PluginString
{
  ...
  MSG_CERT_TEXT,
  MSG_KEY_TYPE_CONVERT,

  MSG_CERT_FILENAME_PROMPT_TITLE,
  MSG_CERT_FILENAME_PROMPT,
  ...
  MSG_SPEED_UNLIMITED,
  MSG_FTPS_IMPLICIT,
  MSG_FTPS_EXPLICIT_SSL,
  MSG_FTPS_EXPLICIT_TLS,
  ...
  WINSCPFAR_BASED_COPYRIGHT "Copyright © 2000-2014 Martin Prikryl"
};
