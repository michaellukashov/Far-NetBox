...
const TFarPluginStrings FarPluginStrings[] =
{
  ...
  { COMMAND_FAILED2, MSG_COMMAND_FAILED },
  ...
  { CLEANUP_CACHES_ERROR, MSG_CLEANUP_CACHES_ERROR },
...
//  { KEY_TYPE_DIFFERENT_SSH, MSG_KEY_TYPE_DIFFERENT_SSH },
  { KEY_TYPE_SSH1, MSG_KEY_TYPE_SSH1 },
...
//  { FTP_ACCESS_DENIED_EMPTY_PASSWORD, MSG_FTP_ACCESS_DENIED_EMPTY_PASSWORD },
  ...
  { ALG_NOT_VERIFIED, MSG_ALG_NOT_VERIFIED },
//  { KEX_NOT_VERIFIED, MSG_KEX_NOT_VERIFIED },
  ...
  { NEON_INIT_FAILED2, MSG_NEON_INIT_FAILED2 },
  ...
  { SIZE_INVALID, MSG_SIZE_INVALID },
  { KNOWN_HOSTS_NOT_FOUND, MSG_KNOWN_HOSTS_NOT_FOUND },
  { KNOWN_HOSTS_NO_SITES, MSG_KNOWN_HOSTS_NO_SITES },
  { HOSTKEY_NOT_MATCH_CLIPBOARD, MSG_HOSTKEY_NOT_MATCH_CLIPBOARD },
  { S3_ERROR_RESOURCE, MSG_S3_ERROR_RESOURCE },
  { S3_ERROR_FURTHER_DETAILS, MSG_S3_ERROR_FURTHER_DETAILS },
  { S3_ERROR_EXTRA_DETAILS, MSG_S3_ERROR_EXTRA_DETAILS },
  { S3_STATUS_ACCESS_DENIED, MSG_S3_STATUS_ACCESS_DENIED },
  { DUPLICATE_FOLDER_NOT_SUPPORTED, MSG_DUPLICATE_FOLDER_NOT_SUPPORTED },
  { MISSING_TARGET_BUCKET, MSG_MISSING_TARGET_BUCKET },
  { S3_UPLOAD_NEED_FILENAME, MSG_S3_UPLOAD_NEED_FILENAME },
  ...
  { CORE_PROMPT_FILE_OVERWRITE, MSG_PROMPT_FILE_OVERWRITE },
  { DIRECTORY_OVERWRITE, MSG_DIRECTORY_OVERWRITE },
  { CIPHER_TYPE_BOTH2, MSG_CIPHER_TYPE_BOTH2 },
  { CIPHER_TYPE_CS2, MSG_CIPHER_TYPE_CS2 },
  { CIPHER_TYPE_SC2, MSG_CIPHER_TYPE_SC2 },
...
//  { KEX_BELOW_THRESHOLD, MSG_KEX_BELOW_THRESHOLD },
  ...
  { TUNNEL_INSTRUCTION2, MSG_TUNNEL_INSTRUCTION },
  ...
  { KEY_TYPE_CONVERT4, MSG_KEY_TYPE_CONVERT4 },
  { MULTI_FILES_TO_ONE, MSG_MULTI_FILES_TO_ONE },
  { KEY_EXCHANGE_ALG, MSG_KEY_EXCHANGE_ALG },
  { KEYKEY_TYPE, MSG_KEYKEY_TYPE },
  { S3_ACCESS_KEY_ID_TITLE, MSG_S3_ACCESS_KEY_ID_TITLE },
  { S3_ACCESS_KEY_ID_PROMPT, MSG_S3_ACCESS_KEY_ID_PROMPT },
  { S3_SECRET_ACCESS_KEY_TITLE, MSG_S3_SECRET_ACCESS_KEY_TITLE },
  { S3_SECRET_ACCESS_KEY_PROMPT, MSG_S3_SECRET_ACCESS_KEY_PROMPT },
  { DUPLICATE_FOLDER_NOT_SUPPORTED, MSG_DUPLICATE_FOLDER_NOT_SUPPORTED },
  ...
  { STATUS_CLOSED, MSG_STATUS_CLOSED },
...
//  { CODE_YOUR_CODE, MSG_CODE_YOUR_CODE },
  ...
  { TEXT_FILE_ENCODING, MSG_TEXT_FILE_ENCODING },
  { AND_STR, MSG_AND_STR },
  { AUTH_CHANGING_PASSWORD, MSG_AUTH_CHANGING_PASSWORD },
  { PASTE_KEY_BUTTON, MSG_PASTE_KEY_BUTTON },
  { SCRIPT_CP_DESC, MSG_SCRIPT_CP_DESC },
  { TIME_UNKNOWN, MSG_TIME_UNKNOWN },
//  { KEY_DETAILS, MSG_KEY_DETAILS },
  { COPY_KEY_ACTION, MSG_COPY_KEY_ACTION },
  { COPY_CERTIFICATE_ACTION, MSG_COPY_CERTIFICATE_ACTION },
  ...
  { OPENSSL_VERSION2, MSG_OPENSSL_VERSION2 },
  { OPENSSL_URL, MSG_OPENSSL_URL },
  { NEON_BASED_ON2, MSG_NEON_BASED_ON },
...
//  { UNKNOWN_KEY4, MSG_UNKNOWN_KEY4 },
//  { DIFFERENT_KEY5, MSG_DIFFERENT_KEY5 },
//  { OLD_KEY, MSG_OLD_KEY },
  ...
  { MASTER_PASSWORD_CAPTION, NB_MASTER_PASSWORD_CAPTION },
  { MASTER_PASSWORD_CURRENT, NB_MASTER_PASSWORD_CURRENT },
  { MASTER_PASSWORD_NEW, NB_MASTER_PASSWORD_NEW },
  { MASTER_PASSWORD_CONFIRM, NB_MASTER_PASSWORD_CONFIRM },
  { MASTER_PASSWORD_INCORRECT, NB_MASTER_PASSWORD_INCORRECT },
  { MASTER_PASSWORD_DIFFERENT, NB_MASTER_PASSWORD_DIFFERENT },
  { MASTER_PASSWORD_SIMPLE2, NB_MASTER_PASSWORD_SIMPLE2 },
  { MASTER_PASSWORD_CHANGED, NB_MASTER_PASSWORD_CHANGED },
  { MASTER_PASSWORD_SET2, NB_MASTER_PASSWORD_SET2 },
  { MASTER_PASSWORD_CLEARED2, NB_MASTER_PASSWORD_CLEARED2 },
  { MASTER_PASSWORD_LOCKOUT, NB_MASTER_PASSWORD_LOCKOUT },
  { CONFIG_SECURITY, NB_CONFIG_SECURITY },
  { SECURITY_MASTER_PASSWORD_GROUP, NB_SECURITY_MASTER_PASSWORD_GROUP },
  { SECURITY_USE_MASTER_PASSWORD, NB_SECURITY_USE_MASTER_PASSWORD },
  { SECURITY_CHANGE_MASTER_PASSWORD, NB_SECURITY_CHANGE_MASTER_PASSWORD },
  { SECURITY_SESSION_PASSWORD_GROUP, NB_SECURITY_SESSION_PASSWORD_GROUP },
  { SECURITY_REMEMBER_PASSWORD, NB_SECURITY_REMEMBER_PASSWORD },
  { SECURITY_SSH_HOST_CA_GROUP, NB_SECURITY_SSH_HOST_CA_GROUP },
  { SECURITY_SSH_HOST_CA_FROM_PUTTY, NB_SECURITY_SSH_HOST_CA_FROM_PUTTY },
  { SECURITY_SSH_HOST_CA_ADD_BTN, NB_SECURITY_SSH_HOST_CA_ADD_BTN },
  { SECURITY_SSH_HOST_CA_EDIT_BTN, NB_SECURITY_SSH_HOST_CA_EDIT_BTN },
  { SECURITY_SSH_HOST_CA_REMOVE_BTN, NB_SECURITY_SSH_HOST_CA_REMOVE_BTN },
  { EDIT_CHANGED_EXTERNALLY, NB_EDIT_CHANGED_EXTERNALLY },
