...
const TFarPluginStrings FarPluginStrings[] =
{
  ...
  { KEY_TYPE_UNKNOWN, MSG_KEY_TYPE_UNKNOWN },
  { KEY_TYPE_UNSUPPORTED, MSG_KEY_TYPE_UNSUPPORTED },
  ...
  { FTP_PWD_RESPONSE_ERROR, MSG_FTP_PWD_RESPONSE_ERROR },
  ...
  { KEY_TYPE_CONVERT, MSG_KEY_TYPE_CONVERT },

  { CERT_FILENAME_PROMPT_TITLE, MSG_CERT_FILENAME_PROMPT_TITLE },
  { CERT_FILENAME_PROMPT, MSG_CERT_FILENAME_PROMPT },
  ...
  { COPY_PARAM_PRESET_EXCLUDE, MSG_COPY_PARAM_PRESET_EXCLUDE },
  ...
  { FTPS_EXPLICIT_SSL, MSG_FTPS_EXPLICIT_SSL },
  { FTPS_EXPLICIT_TLS, MSG_FTPS_EXPLICIT_TLS },
