...
BOOST_FIXTURE_TEST_CASE(test2, base_fixture_t)
{
    ...
    if (1)
    {
        ...
        BOOST_CHECK_EQUAL(System::W2MB(str.c_str()), "line 1");
        ...
        BOOST_CHECK_EQUAL(1, strings.GetCount());
        BOOST_CHECK_EQUAL(System::W2MB(strings.GetString(0).c_str()), "line 00");
        strings.Add(L"line 11");
        BOOST_CHECK_EQUAL(2, strings.GetCount());
        BOOST_CHECK_EQUAL(System::W2MB(strings.GetString(1).c_str()), "line 11");
        strings.Delete(1);
        BOOST_CHECK_EQUAL(1, strings.GetCount());
    }
    System::TStringList strings;
    if (1)
    {
        ...
        str = strings.GetText();
        // DEBUG_PRINTF(L"str = %s", str.c_str());
        BOOST_CHECK_EQUAL(System::W2MB(str.c_str()).c_str(), "line 1\n");
    }
    if (1)
    {
...
BOOST_FIXTURE_TEST_CASE(test3, base_fixture_t)
{
    ...
    BOOST_TEST_MESSAGE("Lines 0 = " << System::W2MB(Lines.GetString(0).c_str()));
    BOOST_TEST_MESSAGE("Lines 1 = " << System::W2MB(Lines.GetString(1).c_str()));
    BOOST_CHECK_EQUAL("text text text text text1", System::W2MB(Lines.GetString(0).c_str()).c_str());
    BOOST_CHECK_EQUAL("text text text text text2", System::W2MB(Lines.GetString(1).c_str()).c_str());
}
...
BOOST_FIXTURE_TEST_CASE(test4, base_fixture_t)
{
    ...
    BOOST_CHECK_EQUAL("text", System::W2MB(Lines.GetString(0).c_str()).c_str());
    BOOST_CHECK_EQUAL(" text text", System::W2MB(Lines.GetString(1).c_str()).c_str());
...
BOOST_FIXTURE_TEST_CASE(test6, base_fixture_t)
{
    ...
    Lines.Add(L"bbb");
    Lines.Add(L"aaa");
    // BOOST_TEST_MESSAGE("Lines = " << System::W2MB(Lines.GetText().c_str()).c_str());
    {
        Lines.SetSorted(true);
        // BOOST_TEST_MESSAGE("Lines = " << System::W2MB(Lines.GetText().c_str()).c_str());
        BOOST_CHECK_EQUAL("aaa", System::W2MB(Lines.GetString(0).c_str()).c_str());
        BOOST_CHECK_EQUAL(2, Lines.GetCount());
    }
    {
        ...
        // BOOST_TEST_MESSAGE("Lines = " << System::W2MB(Lines.GetText().c_str()).c_str());
        BOOST_CHECK_EQUAL("aaa", System::W2MB(Lines.GetString(0).c_str()).c_str());
        BOOST_CHECK_EQUAL("Aaa", System::W2MB(Lines.GetString(1).c_str()).c_str());
        BOOST_CHECK_EQUAL("bbb", System::W2MB(Lines.GetString(2).c_str()).c_str());
    }
}
...
BOOST_FIXTURE_TEST_CASE(test7, base_fixture_t)
{
    ...
    Lines.Clear();
    int cnt = 0;
    System::TStringList *Lines1 = new System::TStringList();
    int cnt1 = 0;
    System::TStringList *Lines2 = new System::TStringList();
    {
        Lines.BeginUpdate();
        cnt++;
        Lines1->BeginUpdate();
...
BOOST_FIXTURE_TEST_CASE(test9, base_fixture_t)
{
    ...
    BOOST_TEST_MESSAGE("GetCurrentDir = " << System::W2MB(::GetCurrentDir().c_str()).c_str());
...
{
    System::TDateTime dt1(23, 58, 59, 102);
...
{
    System::TDateTime dt1 = EncodeDateVerbose(2009, 12, 29);
    BOOST_TEST_MESSAGE("dt1 = " << dt1);
...
BOOST_FIXTURE_TEST_CASE(test12, base_fixture_t)
{
    ...
    System::TDateTime dt = ::EncodeDateVerbose(2009, 12, 29);
...
{
    System::TStringList Strings1;
    System::TStringList Strings2;
...
{
    System::TStringList List1;
    List1.SetText(L"123\n456");
    BOOST_CHECK(2 == List1.GetCount());
    BOOST_TEST_MESSAGE("List1.GetString(0) = " << System::W2MB(List1.GetString(0).c_str()));
    BOOST_CHECK("123" == System::W2MB(List1.GetString(0).c_str()));
    BOOST_TEST_MESSAGE("List1.GetString(1) = " << System::W2MB(List1.GetString(1).c_str()));
    BOOST_CHECK("456" == System::W2MB(List1.GetString(1).c_str()));
    List1.Move(0, 1);
    BOOST_TEST_MESSAGE("List1.GetString(0) = " << System::W2MB(List1.GetString(0).c_str()));
    BOOST_CHECK("456" == System::W2MB(List1.GetString(0).c_str()));
    BOOST_TEST_MESSAGE("List1.GetString(1) = " << System::W2MB(List1.GetString(1).c_str()));
    BOOST_CHECK("123" == System::W2MB(List1.GetString(1).c_str()));
}
...
BOOST_FIXTURE_TEST_CASE(test22, base_fixture_t)
{
    ...
    std::string str = "test string";
    {
        ...
        BOOST_CHECK(File != 0);
        System::TStream *FileStream = new TSafeHandleStream(File);
        ...
        ::CloseHandle(File);
        BOOST_TEST_MESSAGE("FileName1 = " << System::W2MB(FileName.c_str()));
        BOOST_REQUIRE(::FileExists(FileName));
    }
    {
        BOOST_TEST_MESSAGE("FileName2 = " << System::W2MB(FileName.c_str()));
        WIN32_FIND_DATA Rec;
...
{
    System::TDateTime now = System::Now();
