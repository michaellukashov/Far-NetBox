...
//---------------------------------------------------------------------------
bool TNetBoxPlugin::HandlesFunction(THandlesFunction Function)
{
...
//---------------------------------------------------------------------------
void TNetBoxPlugin::GetPluginInfoEx(long unsigned & Flags,
  TStrings * DiskMenuStrings, TStrings * PluginMenuStrings,
  TStrings * PluginConfigStrings, TStrings * CommandPrefixes)
{
    DEBUG_PRINTF(L"begin: FarConfiguration = %x", FarConfiguration);
...
//---------------------------------------------------------------------------
bool TNetBoxPlugin::ConfigureEx(int /*Item*/)
{
  bool Change = false;
...
//---------------------------------------------------------------------------
int TNetBoxPlugin::ProcessEditorEventEx(int Event, void * Param)
{
...
//---------------------------------------------------------------------------
int TNetBoxPlugin::ProcessEditorInputEx(const INPUT_RECORD * Rec)
{
  int Result;
...
//---------------------------------------------------------------------------
TCustomFarFileSystem * TNetBoxPlugin::OpenPluginEx(int OpenFrom, int Item)
{
...
//---------------------------------------------------------------------------
void TNetBoxPlugin::CommandsMenu(bool FromFileSystem)
{
  TFarMenuItems * MenuItems = new TFarMenuItems();
  {
      BOOST_SCOPE_EXIT ( (&MenuItems) )
...
//---------------------------------------------------------------------------
void TNetBoxPlugin::MessageClick(void * Token, int Result, bool & Close)
{
...
//---------------------------------------------------------------------------
int TNetBoxPlugin::MoreMessageDialog(std::wstring Str,
  ...
  const TMessageParams * Params)
{
  ...
  TStrings * ButtonLabels = new TStringList();
  {
    ...
    farmessageclick_slot_type slot = boost::bind(&TNetBoxPlugin::MessageClick, this, _1, _2, _3);
