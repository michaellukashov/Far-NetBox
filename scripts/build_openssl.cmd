...
:vs2019-x64
rm -rf vs2019-x64
call "%VS160COMNTOOLS%\..\..\VC\vcvarsall.bat" x86_amd64
perl Configure VC-WIN64A %CONF_PARAMS%
call ms\do_win64a
nmake clean
nmake
mkdir vs2019-x64
cp libssl.lib libcrypto.lib vs2019-x64
cp ossl_static.pdb vs2019-x64
cp -R include vs2019-x64
goto end
...
:vs2019-x86
rm -rf vs2019-x86
call "%VS160COMNTOOLS%\..\..\VC\vcvarsall.bat" x86
perl Configure VC-WIN32 %CONF_PARAMS%
rem call ms\do_nasm
call ms\do_ms
nmake clean
nmake
mkdir vs2019-x86
cp libcrypto.lib libssl.lib vs2019-x86
cp app.pdb ossl_static.pdb vs2019-x86
cp -R include vs2019-x86
goto end
